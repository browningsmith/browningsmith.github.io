 ...
 *              For each object in the "objects" collection, it renders it in to the frame,
 *              then updated that object's rotation based on deltaT.
 */
 ...
 * 
 * Input: Integer object, Double deltaT
 * Output: None
 * 
 * Description: Updates an objects yaw, pitch, and roll based on
 *              the speed of each in the object's attributes, and
 *              the change in time deltaT from the last frame.
 */
